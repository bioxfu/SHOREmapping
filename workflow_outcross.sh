...
echo "# Compress"
xz OC/fg/consensus/ConsensusAnalysis/supplementary_data/consensus_summary.txt
xz BC/bg/consensus/ConsensusAnalysis/quality_reference.txt.xz
xz OC/bg/consensus/ConsensusAnalysis/quality_reference.txt.xz
