...
# Add links
# cd fastq
# ln -s Mut_R1.fastq.gz BC_fg_R1.fastq.gz
# ln -s Mut_R2.fastq.gz BC_fg_R2.fastq.gz
# ln -s Ref_R1.fastq.gz BC_bg_R1.fastq.gz
# ln -s Ref_R2.fastq.gz BC_bg_R2.fastq.gz
# cd ..
...
echo "# 7. Decompress the consensus call information of the mapping population"
